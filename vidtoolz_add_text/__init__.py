...
def create_parser(subparser):
    ...
    parser.add_argument("-p", "--position", choices=["top-left", "top-right", "bottom-left", "bottom-right", "center", "bottom"], default="bottom", help="Position of the text (default: bottom)")
    parser.add_argument("-st","--start-time", type=float, default=2, help="Start time when text should appear")
    parser.add_argument("-et","--end-time", type=float, default=2, help="End time when text should disappear")
    parser.add_argument("-f", "--fontsize", type=int, default=50, help="Fontsize default:50")
...
class ViztoolzPlugin:
    ...
    def run(self, args):
        clip = add_text_to_video(args.main_video, args.text, args.start_time, args.end_time, args.position, args.fontsize)
